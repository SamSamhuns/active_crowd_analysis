...
def run_demo(cfg, ckpt, score_threshold, images_dir, output_dir, dataset_type):
    ...
    print(f"Avg frame rate is {sum(framerates) / len(framerates)} for {len(framerates)} frames")
    wfile.close()
...
def main():
    ...
    parser.add_argument("--images_dir", default='datasets/MOT16/train/MOT16-02/img1', 
