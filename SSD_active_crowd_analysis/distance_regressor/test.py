from distance_regressor.utils import Standardizer, load_standardizer, get_device, load_model_weight
...
if __name__ == "__main__":
    ...
    X = np.array([[98.33, 164.92],
                  [98.33, 164.92]])  # zloc is 8 here
